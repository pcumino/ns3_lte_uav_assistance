...
UavMobilityEnergyModel::Stop (void)
{
  ...
  // NS_LOG_UNCOND("\t\t\u001b[1m\u001b[31m\u001b[3m " << "UAV CHANGE TO STOP: " << UavMobilityEnergyModel::State::STOP << "\u001b[0m");
...
UavMobilityEnergyModel::Ascend (double speed)
{
  ...
  // NS_LOG_UNCOND("\t\t\u001b[1m\u001b[31m\u001b[3m " << "UAV CHANGE TO ASCEND: " << UavMobilityEnergyModel::State::ASCEND << "\u001b[0m");
...
UavMobilityEnergyModel::Descend (double speed)
{
  ...
  // NS_LOG_UNCOND("\t\t\u001b[1m\u001b[31m\u001b[3m " << "UAV CHANGE TO DESCEND: " << UavMobilityEnergyModel::State::DESCEND << "\u001b[0m");
...
UavMobilityEnergyModel::Move (const Vector &velocity)
{
  ...
  // NS_LOG_UNCOND("\t\t\u001b[1m\u001b[31m\u001b[3m " << "UAV CHANGE TO MOVE: " << UavMobilityEnergyModel::State::MOVE << "\u001b[0m");
...
UavMobilityEnergyModel::Hover (void)
{
  ...
  // NS_LOG_UNCOND("\t\t\u001b[1m\u001b[31m\u001b[3m " << "UAV CHANGE TO HOVER: " << UavMobilityEnergyModel::State::HOVER << "\u001b[0m");
